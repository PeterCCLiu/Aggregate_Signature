...
/*
This contract serves as an on-chain signature aggregator and public verifier.
Some functions are implemented here:
    Signature Aggregation
    AggSignature Verification
    PubKey Aggregation

Some are done off-chain, thus not implemented in this contract:
    KeyGen
    Signing of a single transaction

BTW, comment cannot be written in contract. or -> pragma experimental ABIEncoderV2;
